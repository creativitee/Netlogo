...
turtles-own [HP]
players-own [Tears-Speed Tears-Damage]
...
;Fighting
to attack
  if breed = fighters or breed = soldiers [if any? bullets-here [set HP HP - 1]]
end
...
Line -16777216 false 150 180 150 180
